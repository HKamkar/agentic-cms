...
(`content-engine-kit parity`, `content-engine-kit visual-parity`) are for code changes,
not for these files.

## Fields

Every key of every collection, generated from the schemas by
`content-engine-kit docs` (`pnpm content:docs`); `pnpm build` fails when
this section is stale.

<!-- content-docs:start -->

<!-- generated by content-engine-kit docs from the schemas; do not edit by hand -->
