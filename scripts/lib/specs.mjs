  ...
  "visual-parity": {
    ...
    subcommands: {
      capture: {
        ...
        usage: "agentic-cms visual-parity capture <label> [--motion | --states] [--scheme light|dark] [--url <base>] [--widths w,w] [--pages /a,/b] [--fresh]",
        ...
        json: "{ label, dir, pages, widths, files, seconds, reused: { shots, of } | null, timings: { taken, seconds, mean, slowest: [{ name, seconds }] }, meta: { scheme, motion, states, settle, ref, sha, tree: { head, dirty } | null } }",
      },
      compare: {
