...
//
//   agentic-cms docs            rewrites the block between the markers (pnpm content:docs)
//   agentic-cms docs --check    exits 1 when the block is out of date (pnpm build runs this)
//
...
const { lookup, sourceOf } = await import("agentic-cms/content");
...
const generated = [`${START}`, "<!-- generated by agentic-cms docs from the schemas; do not edit by hand -->", "", ...Object.values(collections).map(section), "", END].join("\n\n").replace(/\n\n\n+/g, "\n\n");
